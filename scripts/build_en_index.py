...
def main():
    ...
    for entry in index:
        ...
        source_icon = "🎥" if entry["provider"] == "youtube" else "🐦"
    ...
    <div class="meta"><span>{source_icon} {source_label}</span><span>👤 {meta["subtitle"]}</span><span>📑 {meta["sections"]} sections</span></div>
